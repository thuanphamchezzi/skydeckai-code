...
class GlobalState:
    ...
    def allowed_directory(self) -> str:
        ...
        if self._allowed_directory is None:
            config = self._load_config()
            self._allowed_directory = config.get('allowed_directory', str(Path.home() / "Desktop"))
